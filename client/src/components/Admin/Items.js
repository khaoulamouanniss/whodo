...
export default function Items(props) {
  ...
  const processData = (dataString) => {
    ...
    for (let l of list) {
      ...
      props.submitItem(l.item, l.topic, true);
    }
  ...
  return (
    <>
      <div style={{ marginLeft: "38%", fontWeight: "bold", fontSize: "18px" }}>
        ...
        <i
          onClick={() => props.submitItem(newItem, "topic", true)}
          style={{ marginLeft: "32%", marginTop: "-45px" }}
          class="itemsfas2 fa-plus-square"
        ></i>
      </div>
      <div className="itemstable">
        <div className="itemstd-container">{itemData}</div>
      </div>
    </>
  );
}
