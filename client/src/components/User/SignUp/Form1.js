    ...
    <div className="form1">
      <div className="form1-form">
        <div className="form1-welcome">
          ...
          >
            Thank you for choosing whodo, please complete your registration so
            you can use all the functionalities of whodo.
          </div>
        </div>

        {error !== "" ? <div className="form1-error">{error}</div> : ""}
        <div className="form1-data">
          <label className="form1-label" for="email">
            Email
          </label>
          <br />
          <input
        ...
        <div className="form1-data">
          <label className="form1-label" for="password">
            Password
          </label>
          <input
            className="form1-input"
        ...
        <div className="form1-buttons">
          <button className="form1-button" onClick={onCancel}>
            <i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;Cancel
          </button>
          <button className="form1-button" onClick={onNext}>
