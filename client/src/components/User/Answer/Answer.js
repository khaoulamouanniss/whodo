...
export default function Answer(props) {
  ...
  function filterAnswers(id, filter) {
    if (filter === "gender") {
      ...
      axios
        .get(`http://localhost:8001/answer/${id}/filter/relation`)
        .then((res) => {
    ...
    <div className="div-container">
      ...
      <div className="itemAndButtons">
        <div className="itemHashtagSocialShare">
          <div className="itemHashtag">
            <div className="hashtag">
              <Link
                ...
                to="/answer" /*onClick={() => randomItem(topic)}*/
              >
                <h5>#{topic}</h5>
              </Link>
            </div>
          ...
          {/*end of the title without social share */}
              ...
              <label for="check">
                <div id="button">
                  <i
                    ...
                    onClick={() => expandMenu(socialState)}
        ...
        <div className="voteButtons">
          <div className="graph1">
            <button
              ...
              onClick={(e) => {
                updateAfterClick(e.target.id);
              }}
            >
              {" "}
              {showValues && !enableButtons ? `${percentageNever}%` : ""}{" "}
            </button>
          ...
          <div className="graph2">
            ...
            >
              {showValues && !enableButtons ? `${percentageRarely}%` : ""}{" "}
            </button>
            <div className="hidden">
              <p> Rarely</p>
            </div>
          ...
          <div className="graph4">
            ...
            >
              {showValues && !enableButtons ? `${percentageUsually}%` : ""}{" "}
            </button>
            <div className="hidden">
              <p> usually</p>
            </div>
          ...
          <div className="graph5">
            ...
            >
              {" "}
              {showValues && !enableButtons ? `${percentageAlways}%` : ""}{" "}
            </button>
            <div className="hidden">
              <p> always</p>
            </div>
