...
CREATE TABLE users(id SERIAL PRIMARY KEY,name VARCHAR(255) NOT NULL,last_name VARCHAR(255) ,birth_date VARCHAR(20) ,gender VARCHAR(255),email VARCHAR(255) NOT NULL,password VARCHAR(255),profile_pic VARCHAR(255),country VARCHAR(255),city VARCHAR(255),referrer VARCHAR(255),type VARCHAR(255),relationship VARCHAR(255));
