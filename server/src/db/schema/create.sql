...
CREATE TABLE items(id SERIAL PRIMARY KEY,topic_id INTEGER REFERENCES topics(id) ON DELETE CASCADE,creator_id INTEGER REFERENCES users(id) ON DELETE CASCADE,item VARCHAR(80) NOT NULL,time timestamp NOT NULL,approved BOOLEAN NOT NULL);
