...
relationship VARCHAR(255), user_level SMALLINT NOT NULL DEFAULT 1);


CREATE TABLE topics(id SERIAL PRIMARY KEY,topic VARCHAR(255) NOT NULL, topic_level SMALLINT NOT NULL);
