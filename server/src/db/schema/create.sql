...
CREATE TABLE users(id SERIAL PRIMARY KEY,name VARCHAR(255) NOT NULL,last_name VARCHAR(255) NOT NULL,birth_date VARCHAR(20) NOT NULL,gender VARCHAR(255) NOT NULL,email VARCHAR(255) NOT NULL,password VARCHAR(255),profile_pic VARCHAR(255),country VARCHAR(255) NOT NULL,region VARCHAR(255) NOT NULL,city VARCHAR(255) NOT NULL,referrer VARCHAR(255),type VARCHAR(255) NOT NULL,relationship VARCHAR(255) NOT NULL,family VARCHAR(255) NOT NULL);
